 ...
 */
export function formatPetDescription(pet: Pet): string {
  return `${pet.name} is a ${pet.age} year old ${pet.color} ${pet.breed}`
}

/**
 * Count pets by species
 */
export function countBySpecies(pets: Pet[], species: string): number {
